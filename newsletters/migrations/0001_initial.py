    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('завершена', 'Завершена'), ('создана', 'Создана'), ('запущена', 'Запущена')], default='создана', max_length=10)),
                ('message', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='newsletters.message', verbose_name='Сообщение')),
                ('recipient', models.ManyToManyField(to='newsletters.recipient', verbose_name='Получатели')),
            ],
            options={
