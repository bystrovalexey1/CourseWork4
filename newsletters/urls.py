...
urlpatterns = [
    ...
    path(
        "distribution_list/", DistributionListView.as_view(), name="distribution_list"
    ),
    path(
        "distribution_detail/<int:pk>/",
    ...
    path(
        "distribution_start/<int:pk>/",
        StartDistributionView.as_view(),
